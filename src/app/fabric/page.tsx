...
export default function FabricPage() {
  return (
    <main style={{ paddingBottom: '4rem' }}>
      <div className="page-header" style={{ paddingTop: '8rem', paddingBottom: '4rem', background: 'var(--primary)' }}>
        <div className="container" style={{ textAlign: 'center' }}>
          <motion.h1 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            style={{ fontSize: '3.5rem', marginBottom: '1rem', color: 'white', textTransform: 'uppercase', fontWeight: 800 }}
          >
            PREMIUM FABRICS
          </motion.h1>
          <p style={{ color: 'white', fontSize: '1.2rem', maxWidth: '600px', margin: '0 auto', fontWeight: 500 }}>
